//
//  DCookieViewController.m
//  WKWebView-Demo
//
//  Created by Luo Wei on 2020/9/25.
//  Copyright © 2020 Luo Wei. All rights reserved.
//

#import "DCookieViewController.h"

@interface DCookieViewController () <WKHTTPCookieStoreObserver, WKNavigationDelegate, WKUIDelegate>

@property(nonatomic, strong) WKWebView *webView;

@end

@implementation DCookieViewController


+ (instancetype)viewController {
    DCookieViewController *vc = [DCookieViewController new];
    return vc;
}
...
- (void)viewDidLoad {
    ...
    WKUserScript * cookieScript = [[WKUserScript alloc] initWithSource: @"document.cookie = 'name=zhouhao';" injectionTime:WKUserScriptInjectionTimeAtDocumentStart forMainFrameOnly:NO];
    [userContentController addUserScript:cookieScript];
    
//    cookieScript = [[WKUserScript alloc] initWithSource: @"document.cookie = 'hm=alkdhfkajhdslfkjhadslkjfhksdjhfjh';" injectionTime:WKUserScriptInjectionTimeAtDocumentStart forMainFrameOnly:NO];
//    [userContentController addUserScript:cookieScript];
    ...
    NSString *urlString = @"http://www.camplife.com.cn/api/web/cookietest.html";
